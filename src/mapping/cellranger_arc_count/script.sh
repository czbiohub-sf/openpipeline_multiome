...
## VIASH START
par_input='resources_test/cellranger_arc_tiny_fastqs/cellranger_arc_libraries.csv'
par_reference='resources_test/cellranger_arc_tiny_fastqs/cellranger_arc_tiny_ref/'
par_output='resources_test/cellranger_arc_tiny_fastqs/bam'
...
echo "Running cellranger_arc count"
